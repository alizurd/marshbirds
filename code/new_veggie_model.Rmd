...
# # Create lookup table — maps terra's integer ID back to your point_id
# plot_lookup <- plots %>%
#   st_drop_geometry() %>%
#   mutate(ID = row_number()) %>%
#   select(ID, point_id)          # <-- keep both columns
...
all_values <- all_values %>%
  mutate(point_id = plots$point_id[ID])   # now has point_id column
...
percent_cover <- percents %>%                     # <-- was percents_with_names
