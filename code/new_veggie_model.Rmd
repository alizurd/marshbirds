...
knitr::opts_knit$set(root.dir = "/Users/alyssabueno/Desktop/marshbirdsoutput/round_12") # increase by 1 everytime you run a new model
...
for (i in 1:length(rasters)) { # starting a loop over all rasters (rasters has 3 rasters, so i = 1,2,3)
  ...
  # Extract
  extracted_i <- terra::extract(full_stack, polygon, df = TRUE) # extract the pixels from the polygons
  extracted_i$ID <- NULL
