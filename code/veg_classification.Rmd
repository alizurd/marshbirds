...
# load test raster
test_rast <- rast("/Users/alyssabueno/Desktop/marshbirds_data/test_clips/test_clips_bx.tif")   # change to li or gb as needed

# make prediction raster
pred_rast <- predict(test_rast, rf_model, type = "response")

# plot it
plot(pred_rast, col = c("forestgreen", "goldenrod", "steelblue", "firebrick"),
     main = "Predicted Classes (BX Test Raster)")
