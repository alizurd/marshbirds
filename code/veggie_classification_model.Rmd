...
extracted_clean$class <- ifelse(extracted_clean$class %in% c("md", "ow"), "ow", extracted_clean$class)
...
# set mud and open water as the same class = ow
extracted_test$class <- ifelse(extracted_test$class %in% c("md", "ow"), "ow", extracted_test$class)
...
plots <- st_set_crs(plots, crs(rast(classified_files[1])))  # match CRS to rasters
